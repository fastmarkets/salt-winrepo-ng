clamav:
  '0.99.1':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/clamav/clamav-0.99.1-x64.msi'
    {% elif grains['cpuarch'] == 'x86' %}
    full_name: 'ClamAV'
    # Official download link - https://www.clamav.net/downloads/production/clamav-0.99.1-win32.msi
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/clamav/clamav-0.99.1-win32.msi'
    {% endif %}
    install_flags: '/qr'
    locale: en_US
    reboot: False
  ...
  '0.98.7':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/clamav/clamav-0.98.7-x64.msi'
    {% elif grains['cpuarch'] == 'x86' %}
    full_name: 'ClamAV'
    # Official download link - https://www.clamav.net/downloads/production/clamav-0.98.7-win32.msi
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/clamav/clamav-0.98.7-win32.msi'
    {% endif %}
    install_flags: '/qr'
    locale: en_US
    reboot: False
