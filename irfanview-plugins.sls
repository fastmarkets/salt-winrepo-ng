irfanview-plugins:
  '4.40':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/irfanview_plugins_x64_440_setup.exe'
    # download manually from: http://www.irfanview.info/files/irfanview_plugins_x64_440_setup.exe and place on master
    {% elif grains['cpuarch'] == 'x86' %}
    full_name: 'Irfanview Plugins 4.40'
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/irfanview_plugins_440_setup.exe'
  ...
  '4.38':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/irfanview_plugins_438_setup.exe'
