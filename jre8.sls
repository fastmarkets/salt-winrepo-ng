jre8:
  '8.0.730.2':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/jre-8u73-windows-x64.exe'
    ...
    # and put it on the winrepo on master to install it the 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/... way
    # to find manual download links for any version use:
    # http://www.java.com/en/download/manual.jsp
    {% elif grains['cpuarch'] == 'x86' %}
    full_name: 'Java 8 Update 73'
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/jre-8u73-windows-i586.exe'
    ...
    # and put it on the winrepo on master to install it the 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/... way
    # to find manual download links for any version use:
    # http://www.java.com/en/download/manual.jsp
    {% endif %}
  ...
  '8.0.710.15':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/jre-8u71-windows-x64.exe'
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/jre-8u71-windows-i586.exe'
  ...
  '8.0.660.18':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/jre-8u66-windows-x64.exe'
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/jre-8u66-windows-i586.exe'
  ...
  '8.0.600.27':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/jre-8u60-windows-x64.exe'
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/jre-8u60-windows-i586.exe'
  ...
  '8.0.510':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8/jre-8u51-windows-x64.exe'
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre8_x86/jre-8u51-windows-i586.exe'
