...
irfanview:
  '4.40':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/iview440_x64_setup.exe'
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/iview440_setup.exe'
  ...
  '4.38':
    full_name: 'IrfanView (remove only)'
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/irfanview/iview438_setup.exe'
