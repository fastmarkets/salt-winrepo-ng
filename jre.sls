...
jre:
  '7.0.790':
    ...
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre/jre-7u79-windows-x64.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F06417079FF} /norestart'    
    {% elif grains['cpuarch'] == 'x86' %}
    full_name: 'Java 7 Update 79'
    installer: 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre_x86/jre-7u79-windows-i586.exe'
    ...
    # and put it on the winrepo on master to install it the 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre_x86/... way    
    {% endif %}
    ...
    # and put it on the winrepo on master to install it the 'salt://{{ salt["pillar.get"]("repo_binary_root", "win/repo-ng") }}/jre/... way
